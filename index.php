  ...
  <div id="myDiv">
    ...
    <section class="cf team-container" id="team">
      <h1 class="team-h1">Our Team</h1>
        ...
        <!-- member-->
        <div class="team-member">
          <img class="team-photo" src="img/d.jpg">
            <h3>NIKHIL GUPTA</h3>
            <span class="profession">mentor</span>
            <a class="email" href="mailto:email@something.com"><i class="linkedin icon"></i></a>
            <a class="email" href="mailto:email@something.com"><i class="facebook icon"></i></a>
        ...
        <div class="team-member">
          <img class="team-photo" src="img/f.jpg">
            <h3>SAKSHI VERMA</h3>
            <span class="profession">GENERAL SECRETARY</span>
            <a class="email" href="mailto:email@something.com"><i class="linkedin icon"></i></a>
          <a class="email" href="mailto:email@something.com"><i class="facebook icon"></i></a>
          </div>

          <div class="team-member">
            <img class="team-photo" src="img/g.jpg">
              <h3>RITVIK SINGH</h3>
              <span class="profession">SECRETARY</span>
              <a class="email" href="mailto:email@something.com"><i class="linkedin icon"></i></a>
            <a class="email" href="mailto:email@something.com"><i class="facebook icon"></i></a>
            </div>
